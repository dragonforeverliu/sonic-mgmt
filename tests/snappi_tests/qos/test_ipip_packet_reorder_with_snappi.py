...
from tests.common.snappi_tests.snappi_fixtures import snappi_api_serv_ip, snappi_api_serv_port,\
    snappi_api, snappi_testbed_config, rand_one_dut_snappi_portname_oper_up  # noqa: F401
...
def test_ip_in_ip_packet_reorder(snappi_api,  # noqa: F811
                                 ...
                                 rand_one_dut_snappi_portname_oper_up,  # noqa: F811
                                 enum_dut_all_prio,
    ...
    Args:
        ...
        rand_one_dut_snappi_portname_oper_up (str): Snappi-connected port to test, e.g., 's6100-1|Ethernet0'
    ...
    dut_hostname, dut_port = rand_one_dut_snappi_portname_oper_up.split('|')
